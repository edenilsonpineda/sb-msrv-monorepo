...
public class ResponseEntityUtil {
	...
	public <T> ResponseEntity<T> createCustomizedResponse(T body, Integer statusCode, String serviceCode,
	...
	private <T> ResponseEntity<T> createResponse(T body, HttpStatus httpStatus, String serviceCode,
			String serviceDescription) {
